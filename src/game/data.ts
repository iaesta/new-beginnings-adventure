...
export const ACTIONS: GameAction[] = [
  {
    ...
    label: "Work",
    icon: "💼",
    description: "Put in the hours. Build skills and reputation (salary comes after each 15-day cycle).",
    energyCost: 25,
    slotCost: 9,
  ...
  },
  {
    ...
    label: "Practice (2h)",
    icon: "🧪",
    description: "Medium practice session.",
    energyCost: 14,
    slotCost: 2,
    effects: { skills: 10, happiness: -2 },
    minSkills: 20,
  },
  {
    id: "practice_4h",
    ...
    label: "Practice (4h)",
    icon: "🧪",
    description: "Deep practice session.",
    energyCost: 24,
    slotCost: 4,
    effects: { skills: 18, happiness: -4 },
    minSkills: 20,
  },
...
export const ACTION_NARRATIVES: Record<string, string[]> = {
  ...
  practice: [
    "You repeat the fundamentals until they feel steadier.",
    "Hands-on practice makes the theory stick a little better.",
    "You slow down, try again, and improve through repetition.",
  ],
  ...
  practice_1h: [
    "A short burst of practice helps settle one small skill.",
  ],
  practice_2h: [
    "A steady practice session makes your hands and mind cooperate more.",
  ],
  practice_4h: [
    "You go deep into deliberate practice and come out sharper.",
  ],
