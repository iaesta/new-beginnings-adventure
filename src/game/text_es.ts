export const TEXT_ES = {
  ...
  INTRO: {
    ...
    line4: "Tienes $200, una maleta y algo que demostrar.",
    start: "Empezar",
  ...
  LOG: {
    ...
    "log.system.burnoutCrash": "Empujaste demasiado y colapsaste. Mañana será más pesado.",
    "log.system.gameOverBurnout": "Tu cuerpo y mente no pudieron seguir adelante. Alcanzaste tu límite.",
